...
instance IsServerError ErrWithRootKey where
    toServerError = \case
        ...
        ErrWithRootKeyWrongPassphrase wid (ErrPassphraseSchemeUnsupported s) ->
            apiErrorOldDeprecated
                err501 WrongEncryptionPassphrase $ mconcat
...
instance IsServerError ErrMkTransaction where
    toServerError = \case
        ...
        ErrMkTransactionInvalidEra _era ->
            apiErrorOldDeprecated err500 CreatedInvalidTransaction $
            mconcat
...
instance IsServerError ErrConstructTx where
    toServerError = \case
        ErrConstructTxWrongPayload ->
            apiErrorOldDeprecated err403 CreatedInvalidTransaction $
            mconcat
        ...
        ErrConstructTxValidityIntervalNotWithinScriptTimelock ->
            apiErrorOldDeprecated err403
            ValidityIntervalNotInsideScriptTimelock $ T.unwords
...
instance IsServerError ErrBalanceTx where
    toServerError = \case
        ErrOldEraNotSupported (Cardano.AnyCardanoEra era) ->
            apiErrorOldDeprecated err403 BalanceTxEraNotSupported $ T.unwords
        ...
        ErrBalanceTxMaxSizeLimitExceeded ->
            apiErrorOldDeprecated err403 BalanceTxMaxSizeLimitExceeded $
                T.unwords
...
instance IsServerError ErrBalanceTxInternalError where
    toServerError = \case
        ErrUnderestimatedFee coin _st ->
            apiErrorOldDeprecated err500 BalanceTxUnderestimatedFee $ T.unwords
...
instance IsServerError ErrSubmitTransaction where
    toServerError = \case
        ...
        ErrSubmitTransactionForeignWallet ->
            apiErrorOldDeprecated err403 ForeignTransaction $
                mconcat
        ...
        ErrSubmitTransactionPartiallySignedOrNoSignedTx expectedWitsNo foundWitsNo ->
            apiErrorOldDeprecated err403 MissingWitnessesInTransaction $
                mconcat
...
instance IsServerError
  ...
  where
    toServerError e = apiErrorOldDeprecated
        err403 OutputTokenBundleSizeExceedsLimit $ mconcat
...
instance IsServerError
  ...
  where
    toServerError e = apiErrorOldDeprecated
        err403 OutputTokenQuantityExceedsLimit $ mconcat
...
instance IsServerError ErrSelectAssets where
    toServerError = \case
        ...
        ErrSelectAssetsAlreadyWithdrawing tx ->
            apiErrorOldDeprecated err403 AlreadyWithdrawing $ mconcat
...
instance IsServerError (SelectionBalanceError WalletSelectionContext) where
    toServerError = \case
        BalanceInsufficient e ->
            apiErrorOldDeprecated err403 NotEnoughMoney $ mconcat
        ...
        SelectionLimitReached e ->
            apiErrorOldDeprecated err403 TransactionIsTooBig $ mconcat
        ...
        EmptyUTxO ->
            apiErrorOldDeprecated err403 NotEnoughMoney $ T.unwords
...
instance IsServerError ErrUpdateSealedTx where
    toServerError = \case
        ErrExistingKeyWitnesses{} ->
            apiErrorOldDeprecated err400 ExistingKeyWitnesses $ T.unwords
